...
$V_0^+ = \left(\dfrac{e{V}_gZ_{in}}{Z_g + Z_{in}}\right)\left(\dfrac{1}{e^{j\beta l}+ \Gamma e^{-j\beta l}}\right)$ \\
...
$Z_in = \dfrac{Z_0^2}{Z_L}$ for quarter-wavelength transformers
...
$P_{av} = \frac{1}{2}\vert\tilde{I}_L\vert^2R_L$
%---------------------------------------------------------------------------
